...
Download the latest [`qasper-booking-X.Y.Z.zip`](https://github.com/qasper/qasper-booking/releases) and install via WordPress admin → **Plugins → Add New → Upload Plugin**. Activate, then visit **Settings → Qasper Booking** to enter your business slug.
...
```bash
git clone https://github.com/qasper/qasper-booking.git
cd qasper-booking
composer install
```
